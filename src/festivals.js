...
export const FESTIVALS = [
  ...
  { id:"nihondaira", name:"日本平まつり", pref:"静岡",
    date:"2026-07-22", dateLabel:"7/22(水) 19:30〜20:30", verified:true,
    shells:12000, shellsLabel:"約12,000発", durationMin:60,
    lat:34.986, lon:138.469, place:"静岡市清水区 日本平ホテル野外庭園",
    venue:"park", venueLabel:"日本平の高台", maxLabel:"デジタルスターマイン", maxDiaM:250,
    access:"名古屋から:新幹線で静岡駅約60分＋バス",
    tickets:[], ticketNote:"有料観覧席の有無は公式で確認",
    url:"https://hanabi.walkerplus.com/detail/ar0622e00882/",
    note:"第41回。音楽・照明と連動するデジタルスターマインが間断なく上がるショー型花火。" },
  { id:"ooigawa", name:"大井川大花火大会", pref:"静岡",
    date:"2026-08-01", dateLabel:"8/1(土) 19:00〜21:00", verified:true,
    shells:10000, shellsLabel:"約10,000発", durationMin:120,
    lat:34.827, lon:138.18, place:"島田市 大井川河川敷",
    venue:"river", venueLabel:"大井川の広い河川敷", maxLabel:"ワイドスターマイン", maxDiaM:300,
    access:"名古屋から:新幹線＋東海道線で約80分（島田駅）",
    tickets:[], ticketNote:"有料席の有無は公式で確認",
    url:"https://ooigawa-hanabi.jp/",
    note:"川幅を活かした横に広いスターマインが圧巻。両岸から約1万発。" },
  { id:"shimizu", name:"清水みなと祭り 海上花火大会", pref:"静岡",
    date:"2026-08-02", dateLabel:"8/2(日) 19:30〜20:30", verified:true,
    shells:10000, shellsLabel:"約10,000発", durationMin:60,
    lat:35.01, lon:138.503, place:"静岡市清水区 清水港 日の出埠頭",
    venue:"sea", venueLabel:"清水港の海上", maxLabel:"海上スターマイン", maxDiaM:300,
    access:"名古屋から:新幹線で静岡駅約60分＋清水へ",
    tickets:[], ticketNote:"有料観覧席の有無は公式で確認",
    url:"https://www.minatokappore.jp/hanabi/",
    note:"港と富士山を背景にした海上花火。清水みなと祭りのメイン。" },
  { id:"gero", name:"下呂温泉まつり 花火ミュージカル", pref:"岐阜",
    date:"2026-08-03", dateLabel:"8/3(月) 20:00〜20:30", verified:true,
    shells:10000, shellsLabel:"約10,000発", durationMin:30,
    lat:35.807, lon:137.244, place:"下呂市 下呂大橋周辺・飛騨川河川敷",
    venue:"river", venueLabel:"温泉街の飛騨川", maxLabel:"音楽連動スターマイン", maxDiaM:250,
    access:"名古屋から:特急ひだで約90分（下呂駅）",
    tickets:[], statusOverride:{kind:"none", label:"無料観覧"},
    ticketNote:"温泉街の各所から観覧可。宿泊とセットが定番",
    url:"https://www.gero-spa.com/",
    note:"温泉街の狭い谷あいに約1万発が音楽と連動。温泉に浸かりながら見られる名物花火。" },
  { id:"yaizu", name:"焼津海上花火大会", pref:"静岡",
    date:"2026-10-24", dateLabel:"10/24(土) 18:30〜20:00", verified:true,
    shells:8000, shellsLabel:"約8,000発", durationMin:90,
    lat:34.865, lon:138.316, place:"焼津市 焼津漁港 新港地区",
    venue:"sea", venueLabel:"焼津漁港の海上", maxLabel:"海上大玉・ワイド", maxDiaM:300,
    access:"名古屋から:新幹線＋東海道線で約90分（焼津駅）",
    tickets:[], ticketNote:"有料席の有無は公式で確認",
    url:"https://www.yaizu.gr.jp/",
    note:"秋開催。市制75周年で規模拡大。夏の名残を感じる漁港の海上花火。" },
  { id:"fuji", name:"富士まつり", pref:"静岡",
    date:"2026-07-26", dateLabel:"7/26(日) 19:30〜20:30", verified:true,
    shells:6060, shellsLabel:"約6,060発", durationMin:60,
    lat:35.161, lon:138.676, place:"富士市 中央公園・青葉通り",
    venue:"park", venueLabel:"富士山麓の市街地", maxLabel:"市街地スターマイン", maxDiaM:250,
    access:"名古屋から:新幹線で新富士駅約75分",
    tickets:[], statusOverride:{kind:"none", label:"無料観覧"},
    ticketNote:"市民まつりのため無料観覧",
    url:"https://www.city.fuji.shizuoka.jp/1035170000/miryoku/p007462.html",
    note:"富士山のお膝元・市街地で上がる市民まつりのフィナーレ花火。" },
  { id:"tsu", name:"津花火大会", pref:"三重",
    date:"2026-07-25", dateLabel:"7/25(土) 20:00〜21:00", verified:true,
    shells:5000, shellsLabel:"約5,000発", durationMin:60,
    lat:34.6825, lon:136.533, place:"津市 阿漕浦海岸沖",
    venue:"sea", venueLabel:"阿漕浦の海上", maxLabel:"海上大玉＋ドローン", maxDiaM:300,
    access:"名古屋から:近鉄特急で約50分（津駅）",
    tickets:[], ticketNote:"有料席の有無は公式で確認",
    url:"https://tsu-hanabi.info/",
    note:"第73回。冒頭にドローンショー、遮るもののない海岸から大玉が上がる。" },
  { id:"matsusaka", name:"松阪花火大会", pref:"三重",
    date:"2026-08-01", dateLabel:"8/1(土) 松阪港", verified:true,
    shells:5000, shellsLabel:"約5,000発", durationMin:60,
    lat:34.569, lon:136.539, place:"松阪市 松阪港（阪内川河口付近）",
    venue:"sea", venueLabel:"松阪港", maxLabel:"港の大玉", maxDiaM:280,
    access:"名古屋から:近鉄特急で約70分（松阪駅）",
    tickets:[], ticketNote:"有料席の有無は公式で確認",
    url:"https://www.kankomie.or.jp/season/article/56",
    note:"松阪港を舞台にした城下町の夏の一大イベント。例年6万人が集う。" },
  { id:"toyohama", name:"豊浜花火大会", pref:"愛知",
    date:"2026-07-18", dateLabel:"7/18(土) 19:40〜20:10", verified:true,
    shells:3500, shellsLabel:"約3,500発", durationMin:30,
    lat:34.719, lon:136.912, place:"南知多町 豊浜漁港埋立地周辺",
    venue:"sea", venueLabel:"豊浜漁港の海上", maxLabel:"知多半島最大級の尺玉", maxDiaM:320,
    access:"名古屋から:名鉄＋バスで約90分（河和駅方面）",
    tickets:[], ticketNote:"有料席の有無は公式で確認",
    url:"https://sorahanabi.com/aichi/minamichita/toyohama-hanabitaikai.html",
    note:"知多半島最大級の海上大玉。ぎおん祭のフィナーレを飾る。" },
  { id:"neogawa", name:"根尾川花火大会", pref:"岐阜",
    date:"2026-10-10", dateLabel:"10/10(土) 19:00〜19:40", verified:true,
    shells:6000, shellsLabel:"約6,000発", durationMin:40,
    lat:35.4247, lon:136.68, place:"本巣市 薮川橋上流の根尾川河畔",
    venue:"river", venueLabel:"根尾川の河畔", maxLabel:"特大8号玉・彩色千輪", maxDiaM:250,
    access:"名古屋から:JR＋樽見鉄道で約90分",
    tickets:[], ticketNote:"有料席の有無は公式で確認",
    url:"https://hanabi.walkerplus.com/detail/ar0621e00822/",
    note:"秋開催。澄んだ秋空に特大8号玉が映える東海屈指の秋花火。" },
];
